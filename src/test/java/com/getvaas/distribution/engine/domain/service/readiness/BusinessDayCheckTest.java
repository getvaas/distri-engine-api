...
class BusinessDayCheckTest {
    ...
    void evaluate_weekday_passes() {
        ...
        var context = new ReadinessCheckContext(3L, monday, "Colombia (COL)", null, null, null);
    ...
    void evaluate_saturday_fails() {
        ...
        var context = new ReadinessCheckContext(3L, saturday, "Colombia (COL)", null, null, null);
    ...
    void evaluate_sunday_fails() {
        ...
        var context = new ReadinessCheckContext(3L, sunday, "Colombia (COL)", null, null, null);
